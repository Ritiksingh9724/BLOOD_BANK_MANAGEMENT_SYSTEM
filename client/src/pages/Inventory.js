  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        ...
        "https://blood-bank-management-system-backend-sotl.onrender.com/api/v1/inventory/add-inventory",
    ...
    try {
      ...
      const res =
        await axios.delete(
          ...
          `
https://blood-bank-management-system-backend-sotl.onrender.com/api/v1/inventory/delete-inventory/${id}`
